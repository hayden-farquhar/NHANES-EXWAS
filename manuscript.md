...
abstract: |
  ...
  **Results:** Of 26 FDR-significant associations, 15 of 21 testable (71%) validated cross-cycle with concordant direction and p < 0.05; of these, 14 remained robust after analyte-specific sensitivity checks, with urinary creatinine adjustment identifying the iodine--BMI association as a dilution artifact. All 15 showed significant dose--response trends, and all survived alcohol adjustment in the available subsample (n = 1,035--3,143). Three HIGH-novelty associations emerged, of which two---dimethylarsonic acid with uric acid ($\beta$ = 0.20 mg/dL per log-unit DMA, 95% CI: 0.15--0.26) and urinary perchlorate with BUN ($\beta$ = 1.21 mg/dL per log-unit perchlorate, 95% CI: 0.97--1.45)---survived dietary confounding assessment; the third (methylmercury--waist circumference) is likely explained by fish consumption patterns.
